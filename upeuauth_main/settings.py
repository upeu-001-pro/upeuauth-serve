"""
Django settings for upeuauth_main project on Heroku. For more info, see:
...
SECRET_KEY = "-u(3!#zcivy*5&b*_rnqyt#vo(&ct1p97t9-0zu=3$n&v04anx"
...
ROOT_URLCONF = 'upeuauth_main.urls'
...
WSGI_APPLICATION = 'upeuauth_main.wsgi.application'
